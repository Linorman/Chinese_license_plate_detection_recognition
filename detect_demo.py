...
def draw_result(orgimg, dict_list):
    ...
    for result in dict_list:
        ...
        cv2.rectangle(orgimg, (rect_area[0], rect_area[1]), (rect_area[2], rect_area[3]), colors[label], 2)  # 画框
        cv2.putText(img, str(label), (rect_area[0], rect_area[1]), cv2.FONT_HERSHEY_SIMPLEX, 0.5, colors[label], 2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--detect_model', nargs='+', type=str, default='runs/train/exp32/weights/last.pt',
                        help='model.pt path(s)')  # 检测模型
    parser.add_argument('--image_path', type=str,
                        default='/mnt/Gpan/Mydata/pytorchPorject/datasets/ccpd/train_detect/gangao', help='source')
